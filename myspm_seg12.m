...
if ~isfield(EXP,'mrf'), EXP.mrf=1; end
if ~isfield(EXP,'cleanup'), EXP.cleanup=1; end
...
if isfield(EXP,'asian')&&EXP.asian
matlabbatch{1}.spm.spatial.preproc.warp.affreg = 'estern'; % estern asian
end  
