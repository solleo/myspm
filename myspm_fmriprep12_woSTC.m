function EXP = myspm_fmriprep12_woSTC (EXP)
...
matlabbatch{1}.spm.util.disp.data = {[EXP.fname_epi,',1']};
...
for j=1:75
matlabbatch{2}.spm.spatial.realignunwarp.data.scans(j) = {[EXP.fname_epi,',',num2str(j)]};
end
