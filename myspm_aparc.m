...
% EXP = myspm_aparc(EXP)
%
% coregister automatic parcellation (a2009s) from freesurfer 
% into functional volumetric space
...
for k=EXP.aparcs
  for n=1:numel(subjID)
    ...
    % simplifying lables
    fname_aparc=['o',segname,'.nii'];
    nii = load_untouch_nii(fname_aparc);
    nii1=nii;
    nii1.img = nii1.img*0;
