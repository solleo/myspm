function myspm_skullstriping12(fname_t1w)
...
%%
ls(fname_t1w);
if strcmp(fname_t1w(1),'/')
  [dir1,~,~]=fileparts(fname_t1w);
else
  dir1=pwd;
end

% 1. t1w preproc (unified segmentation)
matlabbatch={};
matlabbatch{1}.spm.spatial.preproc.channel.vols = {[fname_t1w,',1']};
...
matlabbatch{2}.spm.util.imcalc.output = 'Brain';
