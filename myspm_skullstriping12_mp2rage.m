function myspm_skullstriping12_mp2rage(fnames)
% myspm_skullstriping12_mp2rage(fname_uni, fnames_qt1)
...
matlabbatch={};
matlabbatch{1}.spm.spatial.preproc.channel.vols = {[fnames.uni,',1']};
...
matlabbatch{2}.spm.util.imcalc.output = ['Brain1'];
matlabbatch{2}.spm.util.imcalc.outdir = {p1};
...
unix(['fslmaths ',fnames.qt1,' -thr 50 -bin -mul Brain1 Brain2']);
