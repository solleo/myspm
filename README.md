...
<ul>
<li><code>myspm_fmriglm.m</code> performs statistical inference on 4-D fMRI data using SPM's 1st-level GLM modules.</li>
<li><code>myspm_glm.m</code> performs statistical inference on any 3-D data using SPM's GLM modules.</li>
