...
% $Id: spm_spm.m 4515 2011-10-07 18:26:00Z guillaume $

% sgKIM: in order not to delete residual images: set global variable KeepResiduals to be non-zero
% see edited lines at 941~951 (2015-06-07)
...
% +++ sgKIM:2015:to keep residuals ====
global KeepResiduals;
if ~exist('KeepResiduals','var')
